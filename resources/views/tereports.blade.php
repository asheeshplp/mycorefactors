	 ...
	 <main class="col-md-12 ms-sm-auto col-lg-12 pb-5" id="main-wrapper">
          <div class="container-fluid px-3">
            <div class="note-container-accessment justify-content-center">
              <img src="{{ asset('img/icon-typeelements.png') }}" width="58px" height="auto" />
              <h1 class="mb-0 text-white">Type Elements</h1>
            </div>
          </div>
                ...
                <div class="card card-bg-gray">
                  <div class="card-body">
                    <div class="btn-info d-flex gap-3">
                        <a href="{{ url('typeelements') }}" id="typeelements" class="active btn-info-comman uppertab">My Report</a>
                  ...
                  <div class="row">
					...
					<div class="fixed-side-menu">
						 <ul class="nav nav-tabs flex-column tabs-vertical" id="myTab" role="tablist">
                          <li class="nav-item menu-btn" id="introductionte" role="presentation">
                            <a class="nav-link border-0 active" id="social-dynamics-navigator"
                              href="javascript:void(0);">Introduction</a>
                          </li>
                          <li class="nav-item dropdown menu-btn" id="fourdichotomies">
                            <a class="nav-link dropdown-toggle d-flex justify-content-between" href="#" id="four-dichotomies">
                          ...
                          <li class="nav-item menu-btn" id="typedimensionresults" role="presentation">
                            <a class="nav-link border-0" id="social-dynamics" href="type-dimension-results.html">Type Dimension Results</a>
                          </li>

                          <li class="nav-item dropdown menu-btn" id="wholetyperesults">
                          ...
                          <li class="nav-item dropdown menu-btn" id="elementstyperesults">
                            <a class="nav-link dropdown-toggle d-flex justify-content-between active" href="javascript:void(0);" id="elements-type-results">Your Elements of Type Results<span class="material-icons" onclick="toggleDropdown(event)">expand_more</span></a>
                                                        <ul class="dropdown-menu show"
                                                            aria-labelledby="elements-type-results">
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    onclick="scrollToContent('#energy-acquisition', '#elements-type-results', '#elements-type-resultsTabContent')">Energy
                                                                    Acquisition and Distribution
                                                                </a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    onclick="scrollToContent('#perceiving-attending', '#elements-type-results', '#elements-type-resultsTabContent')">Perceiving
                                                                    or Attending to Information</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    onclick="scrollToContent('#deciding-making-judgments', '#elements-type-results', '#elements-type-resultsTabContent')">Deciding
                                                                    or Making Judgments</a>
                                                            </li>
                                                            <li>
                                                                <a class="dropdown-item"
                                                                    onclick="scrollToContent('#orientation-to-living', '#elements-type-results', '#elements-type-resultsTabContent')">Orientation
                                                                    to Living</a>
                                                            </li>
                                                        </ul>
                          </li>

                          <li class="nav-item menu-btn" id="typeformation" role="presentation">
                            <a class="nav-link border-0" id="social-dynamics" href="javascript:void(0);">Type
                              Formation
                              Results</a>
                          </li>
                        </ul>
...
<input type="hidden" id="pagename" value="tereportpage" />
