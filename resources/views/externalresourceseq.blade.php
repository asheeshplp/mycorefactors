	 ...
	 <main class="col-md-12 ms-sm-auto col-lg-12 pb-5" id="main-wrapper">
          <div class="container-fluid px-3">
            <div class="note-container-accessment justify-content-center">
              ...
              <h1 class="mb-0 text-white">External Resources</h1>
            </div>
          </div>
				...
				<div class="card card-bg-gray">
                  <div class="card-body">
					<div class="btn-info d-flex gap-3">
                        ...
                        <a href="{{ url('externalresourceseq') }}" id="externalresources" class="active btn-info-comman uppertab">External Resources</a>                        
                    </div>
					<div class="row">
						<div class="col-md-12">
