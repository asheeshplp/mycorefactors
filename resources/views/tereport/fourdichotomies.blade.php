...
<div class="tab-content tabs-vertical" id="fourDichotomiesTabContent">
                        <div class="tab-pane fade show active" id="introduction" role="tabpanel" aria-labelledby="home-tab">
                          <div class="tab-content py-4 px-4">                            
                            ...
                            <p class="mb-4">Psychological type describes four core dichotomies that are innate features of your personality. Each of the four dichotomies
                              contains two opposing preferences. The two preferences are seen as psychologically opposite ways of being. Everyone can
                              function at both ends of these dichotomies, although we will have a natural preference for one way over the other. The four
                              dichotomies are:</p>
                            
                            <h4><i>Core Factors Type Elements</i>  assessment reports preferences on four
                            ...
                            <div class="btn-info d-flex justify-content-center gap-3">
                                <a class=" btn-info-comman btn-previous" onclick="showContentte('introductionte');" href="javascript:void(0);">Previous</a>
                                <a class="btn-info-comman btn-next" onclick="showContentte('typedimensionresults');" href="javascript:void(0);">Next</a>
                            </div>
                          </div>
                        </div>                        
                      </div>
